...
/****** Object:  View [views].[HEM_RTW_Agency_Group_Rolling_Month_12_View]    Script Date: 01/13/2016 14:44:23 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[views].[hem_rtw_agency_group_rolling_month_12_view]'))
