...
/****** Object:  View [views].[TMF_RTW_Agency_Group_Rolling_Month_12_View]    Script Date: 01/13/2016 14:45:34 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[views].[tmf_rtw_agency_group_rolling_month_12_view]'))
