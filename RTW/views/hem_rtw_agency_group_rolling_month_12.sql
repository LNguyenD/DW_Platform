...
AS
	...
	SELECT     EmployerSize_Group ='HEM'
				...
				,[Target] = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'target','group','HEM',NULL,t.Measure)
				,Base = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'base','group','HEM',NULL,t.Measure)
	...
	SELECT     EmployerSize_Group= 'HEM'
				...
				,WGT =SUM(t.WGT)  
				,AVGDURN =SUM(LT) / nullif(SUM(WGT),0)  			
				,[Target] = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'target','portfolio','HEM',NULL,t.Measure)
				,Base = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'base','portfolio','HEM',NULL,t.Measure)
	...
	SELECT     EmployerSize_Group= 'HEM'
				...
				,WGT =SUM(t.WGT)  
				,AVGDURN =SUM(LT) / nullif(SUM(WGT),0)  			
				,[Target] = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'target','account_manager','HEM',NULL,t.Measure)
				,Base = udfs.tmf_rtw_gettargetandbase(t.Remuneration_End,'base','account_manager','HEM',NULL,t.Measure)
