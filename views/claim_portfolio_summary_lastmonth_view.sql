IF OBJECT_ID('views.claim_portfolio_summary_lastmonth_view') IS NOT NULL
	DROP VIEW views.claim_portfolio_summary_lastmonth_view
GO
CREATE VIEW views.claim_portfolio_summary_lastmonth_view
AS
	/* agency */
	...
	FROM	(
				select Agency_Name, Claim_No, [System], Claim_Liability_Indicator_Group, Is_Stress, Is_Inactive_Claims, Is_Medically_Discharged, Is_Exempt, Is_Reactive, Claim_Type = 'claim_new_all' 
				from views.claim_portfolio_view
				where Reporting_Date <= '2015-11-30 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59'
				union all
				...
				from views.claim_portfolio_view 
				where Reporting_Date <= '2015-11-30 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59' and is_Time_Lost = 1
				union all 
				...
				from views.claim_portfolio_view 
				where Reporting_Date <= '2015-11-30 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59' and is_Time_Lost = 0
				union all 
				...
				from views.claim_portfolio_view
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					and (Date_Claim_Closed is null or Date_Claim_Closed < '2015-11-30 23:59')
					and (Date_Claim_Reopened is null or Date_Claim_Reopened < '2015-11-30 23:59')
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and (Date_Claim_Reopened is null or Date_Claim_Reopened < '2015-11-30 23:59') 
					and Is_Time_Lost = 1
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 > 0
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 <= 13
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and Is_Time_Lost = 1
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 > 13 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 <= 26
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and Is_Time_Lost = 1 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 > 26 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 <= 52
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and Is_Time_Lost = 1 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 > 52 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 <= 78
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and Is_Time_Lost = 1
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 > 78 
					and DATEDIFF(DAY, Date_of_Injury, DATEADD(DAY, -1, '2015-11-30 23:59')) / 7.0 <= 130
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and NCMM_Complete_Action_Due > '2015-11-30 23:59'
				union all 
				...
				where Reporting_Date <= '2015-11-30 23:59' and Claim_Closed_Flag <> 'Y'
					...
					and NCMM_Prepare_Action_Due between DATEADD(week, 1, '2015-11-30 23:59') and DATEADD(week, 3, '2015-11-30 23:59')
				union all
