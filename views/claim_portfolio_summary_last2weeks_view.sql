...
AS
	...
	FROM	(
				...
				where Reporting_Date <= '2015-12-28 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-12-13' and '2015-12-28 23:59'
				union all
				...
				from views.claim_portfolio_view 
				where Reporting_Date <= '2015-12-28 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-12-13' and '2015-12-28 23:59' and is_Time_Lost = 1
				union all 
				...
				from views.claim_portfolio_view
				where Reporting_Date <= '2015-12-28 23:59' and ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-12-13' and '2015-12-28 23:59' and is_Time_Lost = 0
				union all 
				...
				from views.claim_portfolio_view
				where Reporting_Date <= '2015-12-28 23:59' and Claim_Closed_Flag <> 'Y'
				...
				where Reporting_Date <= '2015-12-28 23:59' and Date_Claim_Closed between '2015-12-13' and '2015-12-28 23:59'
					and (exists (select [Claim_No] from views.claim_portfolio_view cpr_prior
									where Reporting_Date <= DATEADD(DAY, -1, '2015-12-13') + '23:59' and cpr_prior.Claim_No = cpr.Claim_No and cpr_prior.Claim_Closed_Flag = 'N')
										or ISNULL(cpr.Date_Claim_Entered, cpr.date_claim_received) >= '2015-12-13')
				union all 
				...
				from views.claim_portfolio_view
				where Reporting_Date <= '2015-12-28 23:59' and Date_Claim_Reopened between '2015-12-13' and '2015-12-28 23:59'
				union all 
				...
				where Reporting_Date <= '2015-12-28 23:59' and Date_Claim_Reopened between '2015-12-13' and '2015-12-28 23:59'
					and exists (select [Claim_No] from views.claim_portfolio_view cpr_prior
									where Reporting_Date <= DATEADD(DAY, -1, '2015-12-13') + '23:59' and cpr_prior.Claim_No = cpr.Claim_No and cpr_prior.Claim_Closed_Flag = 'Y')
		) as tmp_claim_all
