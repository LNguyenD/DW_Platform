...
AS
	...
	FROM  (select Agency_Name, Claim_No, [System], Claim_Liability_Indicator_Group, Is_Stress, Is_Inactive_Claims, Is_Medically_Discharged, Is_Exempt, Is_Reactive, Claim_Type = 'claim_new_all' 
			...
			where ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59'
			union all
			...
			from views.claim_portfolio_view where ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59' and is_Time_Lost = 1
			union all 
			...
			from views.claim_portfolio_view where ISNULL(Date_Claim_Entered, Date_Claim_Received) between '2015-11-01' and '2015-11-30 23:59' and is_Time_Lost = 0
			union all 
