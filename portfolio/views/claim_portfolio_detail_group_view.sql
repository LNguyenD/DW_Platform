IF OBJECT_ID('views.claim_portfolio_detail_group_view') IS NOT NULL
	DROP VIEW views.claim_portfolio_detail_group_view
GO
CREATE VIEW views.claim_portfolio_detail_group_view
AS
	WITH dte_range AS
	(
	...
	FROM	(
				...
				select Value = [Group], SubValue = Team, SubSubValue = Claims_Officer_Name, [Start_Date], [End_Date], Claim_No, [System], Claim_Liability_Indicator_Group, Is_Stress, Is_Inactive_Claims, Is_Medically_Discharged, Is_Exempt, Is_Reactive,
