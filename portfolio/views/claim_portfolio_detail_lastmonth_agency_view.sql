IF OBJECT_ID('views.claim_portfolio_detail_lastmonth_agency_view') IS NOT NULL
	DROP VIEW views.claim_portfolio_detail_lastmonth_agency_view
GO
CREATE VIEW views.claim_portfolio_detail_lastmonth_agency_view
AS
	/* AGENCY -> SUB_CATEGORY */
	...
	claim_new_all AS
	(
		SELECT Value = Agency_Name, SubValue = Sub_Category, [System], Claim_No, Date_Of_Injury, Is_Time_Lost, Claim_Closed_Flag,
