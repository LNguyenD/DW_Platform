IF OBJECT_ID('views.claim_portfolio_detail_lastmonth_portfolio_view') IS NOT NULL
	DROP VIEW views.claim_portfolio_detail_lastmonth_portfolio_view
GO
CREATE VIEW views.claim_portfolio_detail_lastmonth_portfolio_view
AS
	...
	claim_new_all AS
	(
		SELECT Value = Portfolio, SubValue = EMPL_SIZE, [System], Claim_No, Date_Of_Injury, Is_Time_Lost, Claim_Closed_Flag,
