IF OBJECT_ID('views.claim_portfolio_detail_lastmonth_broker_view') IS NOT NULL
	DROP VIEW views.claim_portfolio_detail_lastmonth_broker_view
GO
CREATE VIEW views.claim_portfolio_detail_lastmonth_broker_view
AS
	/* BROKER */
	...
	claim_new_all AS
	(
		SELECT Value = Broker_Name, [System], Claim_No, Date_Of_Injury, Is_Time_Lost, Claim_Closed_Flag,
